...
const Hero = () => {
  return (
    ...
    >
      {/* Ciemna nakładka, żeby tekst był czytelny na każdym zdjęciu */}
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-5xl">
        ...
        {/* Główne przyciski z makiety */}
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button className="group flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-500 text-white px-8 py-5 rounded-2xl font-bold text-lg sm:text-xl transition-all duration-300 hover:scale-105 shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)]">
            <Map size={28} className="group-hover:-translate-y-1 transition-transform duration-300" />
            REZERWACJA ŁOWISKA
          </button>
          
          <button className="group flex items-center justify-center gap-3 bg-slate-800/80 backdrop-blur-sm hover:bg-slate-700 text-white px-8 py-5 rounded-2xl font-bold text-lg sm:text-xl border border-slate-600 transition-all duration-300 hover:scale-105 shadow-xl">
